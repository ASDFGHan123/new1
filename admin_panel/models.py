...
class AuditLog(models.Model):
    ...
    class ActionType(models.TextChoices):
        ...
        SYSTEM_MESSAGE_SENT = 'SYSTEM_MESSAGE_SENT', 'System Message Sent'
...
class SystemMessage(models.Model):
    """
    Model for system messages that can be broadcast to users or specific groups.
    """
    ...
    priority = models.PositiveIntegerField(default=1)  # 1=Low, 2=Normal, 3=High
    is_persistent = models.BooleanField(default=False)  # Show until dismissed
...
class MessageTemplate(models.Model):
    """
    Model for reusable message templates that can be used for system messages,
    bulk communications, and automated responses.
    """
    ...
    @classmethod
    def set_setting(cls, key, value, category='general', description='', updated_by=None):
