"""
Serializers for chat app with video support.
"""
...
class AttachmentSerializer(serializers.ModelSerializer):
    """Serializer for Attachment model with video support."""
...
class MessageCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        for file in attachments:
            ...
            # Process video metadata if video
            if file_type == 'video':
                try:
                    ...
                    import logging
                    logging.warning(f"Video processing failed: {str(e)}")
